{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 94.0, 44.0, 413.0, 452.0 ],
		"bglocked" : 0,
		"defrect" : [ 94.0, 44.0, 413.0, 452.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 224.0, 152.0, 166.0, 18.0 ],
					"id" : "obj-50",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"text" : "clip 0. 100.",
					"outlettype" : [ "" ],
					"patching_rect" : [ 144.0, 152.0, 61.0, 18.0 ],
					"id" : "obj-44",
					"fontname" : "Arial Bold",
					"numinlets" : 3,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					"maxclass" : "comment",
					"text" : "<",
					"patching_rect" : [ 224.0, 176.0, 19.0, 18.0 ],
					"id" : "obj-27",
					"fontname" : "Arial",
					"frgb" : [ 0.101961, 0.121569, 0.172549, 1.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "+~",
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 32.0, 368.0, 74.5, 18.0 ],
					"id" : "obj-10",
					"fontname" : "Arial Bold",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 224.0, 200.0, 138.0, 18.0 ],
					"id" : "obj-8",
					"fontname" : "Arial",
					"frgb" : [ 0.101961, 0.121569, 0.172549, 1.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 4,
					"patching_rect" : [ 168.0, 72.0, 232.0, 52.0 ],
					"id" : "obj-7",
					"fontname" : "Arial",
					"frgb" : [ 0.101961, 0.121569, 0.172549, 1.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"linecount" : 2,
					"patching_rect" : [ 232.0, 168.0, 125.0, 29.0 ],
					"id" : "obj-6",
					"fontname" : "Arial",
					"frgb" : [ 0.101961, 0.121569, 0.172549, 1.0 ],
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "/ 400.",
					"outlettype" : [ "float" ],
					"patching_rect" : [ 144.0, 176.0, 36.0, 18.0 ],
					"id" : "obj-5",
					"fontname" : "Arial Bold",
					"numinlets" : 2,
					"numoutlets" : 1,
...
, 			{
				"box" : 				{
					...
					"text" : "zl slice 1",
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 144.0, 128.0, 74.0, 18.0 ],
					"id" : "obj-4",
					"fontname" : "Arial Bold",
					"numinlets" : 2,
					"numoutlets" : 2,
...
, 			{
				"box" : 				{
					...
					"text" : "zl join 50.",
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 144.0, 200.0, 74.0, 18.0 ],
					"id" : "obj-3",
					"fontname" : "Arial Bold",
					"numinlets" : 2,
					"numoutlets" : 2,
