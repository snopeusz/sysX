...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 134.0, 136.0, 27.0, 25.0 ],
					"style" : "",
					"text" : "t 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 134.0, 99.0, 61.0, 25.0 ],
					"style" : "",
					"text" : "sel bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 25.0, 176.0, 63.0, 25.0 ],
					"style" : "",
					"text" : "route int"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 25.0, 209.5, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.058083, 2.25, 26.0, 26.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 230.75, 230.166687, 159.0, 25.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 230.75, 388.5, 34.0, 25.0 ],
					"style" : "",
					"text" : "t 0 i"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ -3.5, -4.0 ],
					"outlettype" : [ "int" ],
					"patching_rect" : [ 175.0, 156.5, 67.0, 28.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 30.058083, 2.25, 66.633835, 26.0 ],
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 134.0, 297.5, 29.5, 25.0 ],
					"style" : "",
					"text" : "i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 134.0, 230.166687, 72.0, 25.0 ],
					"style" : "",
					"text" : "t b 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "int" ],
					"patching_rect" : [ 134.0, 197.5, 115.75, 25.0 ],
					"style" : "",
					"text" : "t b i"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 134.0, 262.5, 57.0, 25.0 ],
					"style" : "",
					"text" : "del 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 230.75, 435.166687, 34.0, 25.0 ],
					"style" : "",
					"text" : "+"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "int" ],
					"patching_rect" : [ 134.0, 388.5, 53.0, 25.0 ],
					"style" : "",
					"text" : "/ 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 134.0, 348.5, 90.0, 25.0 ],
					"style" : "",
					"text" : "clocker 1000"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 134.0, 32.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 230.75, 530.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 78.5, 336.25, 143.5, 336.25 ],
					"source" : [ "obj-1", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 34.5, 293.25, 143.5, 293.25 ],
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 143.5, 424.333344, 240.25, 424.333344 ],
					"source" : [ "obj-40", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 240.25, 468.166687, 401.875, 468.166687, 401.875, 147.5, 184.5, 147.5 ],
					"source" : [ "obj-45", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 0,
					"midpoints" : [ 196.5, 337.833344, 143.5, 337.833344 ],
					"source" : [ "obj-61", 1 ]
				}
